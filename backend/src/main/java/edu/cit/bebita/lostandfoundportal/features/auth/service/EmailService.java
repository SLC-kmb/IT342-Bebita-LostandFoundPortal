    ...
    public void sendVerificationEmail(String to, String token, String firstName, String lastName, String studentId) {
        try {
            ...
            String htmlContent = "<div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;'>"
                    ...
                    + "' style='display: inline-block; padding: 10px 20px; background-color: #2563eb; color: white; text-decoration: none; border-radius: 5px;'>Verify Email</a>"
    ...
    public void sendPasswordResetEmail(String to, String token, String firstName) {
        try {
            ...
            String htmlContent = "<div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;'>"
                    ...
                    + "<a href='" + resetUrl
                    + "' style='display: inline-block; margin: 20px 0; padding: 10px 20px; background-color: #2563eb; color: white; text-decoration: none; border-radius: 5px;'>Reset Password</a>"
                    + "<p style='margin-top: 20px; font-size: 0.9em; color: #666;'>"
                    + "If the button doesn't work, copy and paste this link into your browser:<br>"
                    + resetUrl
                    + "</p>"
