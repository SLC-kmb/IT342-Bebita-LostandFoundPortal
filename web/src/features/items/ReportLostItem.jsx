...
export default function ReportLostItem() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.itemName || !form.description || !form.category || !form.building || !form.dateLost) {
    ...
    try {
      ...
      await reportLostItem({ ...form, location: finalLocation, imageUrl });
      setSuccess(true);
        ...
        <div className="form-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                <label htmlFor="building">Where did you lose it? *</label>
                <select
                  id="building"
                  name="building"
                  value={form.building}
